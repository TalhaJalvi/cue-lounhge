 ...
 * @author Talha
 */
public class GamesTable51 implements Initializable {
...
if(tf7_amountpaid_gametable5.getText().isEmpty()){
        ...
        pj.setPrintable(new I().new J(),new I().getPageFormat(pj));
        try {
             pj.print();
        ...
        //Beforing clearing now we have to send data to database
         ...
         try{
            ...
            psmt.setString(1, "0005");//getting password
            ...
            psmt1.setString(4,"Games were played on table 0005 by "+p1n+" and "+p2n);
...
class I extends javax.swing.JFrame{
   //Only extending JFRAME
      GamesTable51  gmp=new GamesTable51();
...
protected static double toPPI(double inch)
    ...
    class J implements Printable{
      long millis=System.currentTimeMillis();  
            java.sql.Date date=new java.sql.Date(millis);
        @Override
        public int print(Graphics graphics, PageFormat pageFormat, int pageIndex) throws PrinterException {

           int r=GamesTable51.gamelist.size();
        ...
        try{
           ...
           // int headerRectHeighta=40;
            ...
            g2d.drawString("-------------------------------------",12,y);y+=headerRectHeight;
             g2d.drawString("Player 1: "+GamesTable51.p1n+" Player 2: "+GamesTable51.p2n+"",12,y);y+=yShift;
            g2d.drawString("-------------------------------------",10,y);y+=headerRectHeight;
            g2d.drawString(" Games                   ",10,y);y+=yShift;
            g2d.drawString("-------------------------------------",10,y);y+=headerRectHeight;
          
           for(int i=0;i<r;i++){
              g2d.drawString(""+GamesTable51.gamelist.get(i)+" "+"                            ",10,y);y+=yShift;
            g2d.drawString("                          ",10,y); g2d.drawString("",160,y);y+=yShift;

           }   
            g2d.drawString("-------------------------------------",10,y);y+=yShift;
            g2d.drawString(" Total amount:               "+String.valueOf(GamesTable51.bill)+"   ",10,y);y+=yShift;
            g2d.drawString("-------------------------------------",10,y);y+=yShift;
            g2d.drawString(" Cash      :                 "+String.valueOf(GamesTable51.amountpaid)+"   ",10,y);y+=yShift;
            g2d.drawString("-------------------------------------",10,y);y+=yShift;
            g2d.drawString(" Cashback   :                 "+String.valueOf(GamesTable51.amountpaid-GamesTable51.bill)+"   ",10,y);y+=yShift;
